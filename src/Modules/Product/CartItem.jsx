...
export default function CartItem({ title, color, size, price, quantity, image }) {
  return (
    ...
    //         <input
    //           type="text"
    //           className="border-y border-gray-200 outline-none text-gray-900 font-semibold text-lg w-12 placeholder:text-gray-900 py-1 text-center bg-transparent px-1.5"
    //           placeholder="1"
    //         />
    ...
    //       </div>
    //     </div>
    //     <div className="flex items-center max-md:mt-3 h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 w-full">
        <div className="md:col-span-2">
          <div className="flex flex-col max-[500px]:items-start gap-3">
            <h6 className="font-semibold text-base leading-7 text-black">Rose Petals Divine</h6>
            <h6 className="font-normal text-base leading-7 text-gray-500">Perfumes</h6>
            <h6 className="font-medium text-base leading-7 text-gray-600 transition-all duration-300">$120.00</h6>
          </div>
        </div>
        <div className="flex items-center md:justify-starts justify-between h-full max-md:mt-3">
        ...
        <div className="flex items-center md:justify-center justify-between max-md:mt-3 h-full">
          ...
          <p className="font-bold text-lg leading-8 text-gray-600 text-center transition-all duration-300">$120.00</p>
        </div>
      </div>
    </div>
  );
