  ...
  return (
    <div className='flex justify-center items-center bg-BgColor'>
      <div className='flex flex-col justify-center items-center'>
          ...
          <div className='grid 2xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mx-5'>
            <div className='md:p-5 p-2 border flex items-center gap-5 bg-red-200 rounded-tr-3xl rounded-bl-3xl'>
              ...
              <div className='flex flex-col md:gap-2 gap-0'>
                <h1 className='md:font-semibold font-bold md:text-xl text-base'>Spring Cleaning for home appliance</h1>
                <p className='md:text-base text-sm'>Get your clean on supplies.</p>
              </div>
            </div>
        ...
        <div className='relative w-full flex justify-start items-start h-full'>
          <img src="https://www.mahmoodrice.com/Content/images/parallax/pirinc.png" alt="" className='w-64 hidden md:flex' />
          <div className='flex justify-center items-center flex-col text-center gap-10 md:w-2/3 w-full pb-10 h-full md:mx-0 px-5'>
            <div>
              <h1 className='font-bold md:text-4xl text-3xl text-center'>About us</h1>
              <div className="flex items-center justify-center mt-5">
                <div className='relative flex justify-center items-center'>
                  <div className='w-36 h-0.5 bg-BgGolden z-20'></div>
                  <div className='absolute w-4 h-4 bg-BgGolden rotate-45 z-10'></div>
        ...
        <div className='container'>
          <div className='flex flex-col justify-center items-center bg-white py-10'>
            <div className='py-10'>
              <h1 className='font-bold md:text-4xl text-3xl text-center'>Our Blogs</h1>
              <div className="flex items-center justify-center mt-5">
                <div className='relative flex justify-center items-center'>
                  <div className='w-36 h-0.5 bg-BgGolden z-20'></div>
                  <div className='absolute w-4 h-4 bg-BgGolden rotate-45 z-10'></div>
        ...
        <div className=' w-full flex flex-col justify-center items-center pb-10 overflow-hidden'>
          <div className='flex justify-center items-center flex-col gap-10 px-5'>
            <div className='text-center'>
              <h1 className='font-bold md:text-4xl text-3xl text-center'>Our Partner Brands</h1>
              <div className="flex items-center justify-center mt-5">
                <div className='relative flex justify-center items-center'>
                  <div className='w-36 h-0.5 bg-BgGolden z-20'></div>
                  <div className='absolute w-4 h-4 bg-BgGolden rotate-45 z-10'></div>
            ...
            <p className='text-center md:w-3/4 w-full md:text-base text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem voluptatem commodi corporis eos eius ipsa eum quos id alias cupiditate.  </p>
          </div>
