...
export default function Footer() {
  return (
    ...
    <footer className="bg-black border-t-2 border-black text-white pt-10 px-4 w-full">
      <div className="mx-auto">
        <h2 className="text-6xl font-serif font-semibold mb-6 text-center">LET'S CONNECT WITH US</h2>
        <form className="flex justify-center mb-12">
          <input
            type="email"
            placeholder="Enter your e-mail"
            className="border-2 bg-transparent outline-none border-white rounded-full px-5 py-3 w-72 "
          />
          <button
            type="submit"
            className="bg-white text-black rounded-full px-5 py-3 ml-2"
          >
            SUBSCRIBE NOW
          </button>
        </form>
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 m-12">
